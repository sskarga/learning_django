...
SECRET_KEY = 'f7c*ye7q9$=29$0ffx-v59a%oosk*y&a+l#nycox^a=v47d93n'
...
INSTALLED_APPS = [
    ...
    # https://django-adminlte2.readthedocs.io/en/latest/index.html
    'django_adminlte',
    ...
    #  Modified Preorder Tree Traversal - https://django-mptt.readthedocs.io/en/latest/overview.html
    'mptt',
